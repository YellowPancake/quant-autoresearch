# Original-protocol archive (not unified accounting)

This page preserves original price-return results and replay commands. Do not mix them with the unified total-return report.
[Return to unified report](README.md)
